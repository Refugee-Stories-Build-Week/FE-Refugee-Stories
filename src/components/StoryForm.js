...
const YourStory = styled.h1`
    color: #5A5D80;
    margin: 15px auto 5px auto;

`;
//////////////////   ERROR STYLES ///////////////////
const ValindInvalid = styled.div`
    display: flex;
...
const validationSchema = Yup.object().shape({
    author: Yup.string().required("Enter Name"),
    title: Yup.string().required("Enter Title"),
    country: Yup.string().required(),
    body: Yup.string().required("Please type in your story")
})
...
const Error = ({ touched, message }) => {
  ...
  return <Valid>Thats Better</Valid>
};
      ...
      <Container onSubmit={handleSubmit}>
        ...
        {/* {JSON.stringify(values)} */}
          <ValindInvalid>
            ...
            <YourStory>Tell Us Your Story!</YourStory>
          ...
          {/* Warning: Underneath is a LOOOONG list of countries */}
            <StyledSelect 
              component="select" 
              name="country" 
              onChange={handleChange}
